...
Install:
    ...
    $ pip install --user git+https://github.com/argriffing/nxctmctree

Test:

    $ python -c "import nxctmctree; nxctmctree.test()"

Uninstall:

    $ pip uninstall nxctmctree
...
Install:
    ...
    $ git clone git@github.com:argriffing/nxctmctree.git
